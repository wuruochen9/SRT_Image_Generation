...
def simulate_ground_truth_new(
    ...
    sigmas_z, sigmas_yx = _get_amp_related_sigma(
        ndim=ndim,
        sigma=sigma,
        gene_exp=gene_exp,
        nb_spots=nb_spots)
...
def _get_amp_related_sigma(ndim, sigma, gene_exp, nb_spots):
    # generate sigma values
    sigmas_z = None
    sigmas_yx = sigma[-1] * gene_exp
    if ndim == 3:
        sigmas_z = sigma[-1] * gene_exp
